...
export const GetClientAppointmentsResponseItem = zod.object({
  ...
  "cupomCodigo": zod.string().nullish().describe('Cupom aplicado, quando houve. O código vem junto do id porque a tela precisa mostrar QUAL cupom foi usado sem fazer outra busca.\n'),
  "valor": zod.number(),
  "desconto": zod.number().optional().describe('Quando há cupom, este valor é calculado pelo servidor a partir do cupom — o desconto enviado pelo cliente é ignorado.\n'),
